...
import client from "../compos/api/client";
...
const ImageUpload = (props) => {
  ...
  // first on clickin on the TouchableOpacity we want to open the image library. 
  const openImageLibrary = async () => {
    // in order to open it we want the user premssion. 
